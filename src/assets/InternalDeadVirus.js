(function (PIXI, lib) {
    ...
    lib.virus_dead_antibodies = Container.extend(function () {
        Container.call(this);
        var instance8 = new lib.virus_dead_sm()
        ...
        var instance6 = new lib.antibody()
            .setTransform(-1.2, 30.05, 0.397, 0.397, -1.443);
        this[instance6.name = "ant2"] = instance6;
        var instance5 = new lib.antibody()
            .setTransform(26.8, -15.25, 0.397, 0.397, 0, 3.543, 2.741);
        this[instance5.name = "ant1"] = instance5;
        var instance4 = new lib.antibody()
            .setTransform(-27.35, 12.7, 0.397, 0.397, -0.367);
        this[instance4.name = "ant5"] = instance4;
        var instance3 = new lib.antibody()
            .setTransform(1.8, -31.05, 0.397, 0.397, 0, 4.585, 1.698);
        this[instance3.name = "ant6"] = instance3;
        var instance2 = new lib.antibody()
            .setTransform(26.5, 14.55, 0.397, 0.397, -2.506);
        this[instance2.name = "ant4"] = instance2;
        var instance1 = new lib.antibody()
            .setTransform(-25.3, -17.6, 0.397, 0.397, 0.678);
        this[instance1.name = "ant3"] = instance1;
