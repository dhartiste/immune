(function (PIXI, lib) {
    ...
    lib.bubbles_back = Container.extend(function () {
        ...
        var instance72 = new Graphics()
            .drawCommands(shapes.Game[158])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance71 = new Graphics()
            .drawCommands(shapes.Game[157])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance70 = new Graphics()
            .drawCommands(shapes.Game[156])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance69 = new Graphics()
            .drawCommands(shapes.Game[155])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance68 = new Graphics()
            .drawCommands(shapes.Game[154])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance67 = new Graphics()
            .drawCommands(shapes.Game[153])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance66 = new Graphics()
            .drawCommands(shapes.Game[152])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance65 = new Graphics()
            .drawCommands(shapes.Game[151])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance64 = new Graphics()
            .drawCommands(shapes.Game[150])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance63 = new Graphics()
            .drawCommands(shapes.Game[149])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance62 = new Graphics()
            .drawCommands(shapes.Game[148])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance61 = new Graphics()
            .drawCommands(shapes.Game[147])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance60 = new Graphics()
            .drawCommands(shapes.Game[146])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance59 = new Graphics()
            .drawCommands(shapes.Game[145])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance58 = new Graphics()
            .drawCommands(shapes.Game[144])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance57 = new Graphics()
            .drawCommands(shapes.Game[143])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance56 = new Graphics()
            .drawCommands(shapes.Game[142])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance55 = new Graphics()
            .drawCommands(shapes.Game[141])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance54 = new Graphics()
            .drawCommands(shapes.Game[140])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance53 = new Graphics()
            .drawCommands(shapes.Game[139])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance52 = new Graphics()
            .drawCommands(shapes.Game[138])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance51 = new Graphics()
            .drawCommands(shapes.Game[137])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance50 = new Graphics()
            .drawCommands(shapes.Game[136])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
        var instance49 = new Graphics()
            .drawCommands(shapes.Game[135])
            .setTransform(-84.05, 8.25, 0.558, 0.558);
    ...
    lib.Game = MovieClip.extend(function () {
        ...
        var instance13 = new Text("Chose one of the types of microorganisms in the beaker and drag over to the right. You can inject your patient with a vaccine or expose them to a microbe, depending on what you have chosen.")
            .setStyle({
                fontFamily: "Tahoma",
                fontSize: 12,
                fontWeight: "bold",
            ...
            .setTransform(606.9, 141.15, 0.771, 0.771);
        this[instance13.name = "instructions"] = instance13;
        var instance12 = new lib.bubbles_back()
            .setTransform(426.6, 135.05, 0.771, 0.771)
            .setAlpha(0.19549)
            .setColorTransform(-0.68, 1, 0.87, -0.6, -0.53, -0.75);
        this[instance12.name = "bubbles"] = instance12;
        var instance11 = new lib.beaker_layered()
            .setTransform(315.55, 218.85, 0.771, 0.771);
        this[instance11.name = "beaker"] = instance11;
        var instance10 = new lib.bacteria()
            .setTransform(407.65, 251.45, 0.478, 0.478);
        this[instance10.name = "bacteria"] = instance10;
        var instance9 = new lib.protein()
            .setTransform(518.6, 259.2, 0.771, 0.771);
        this[instance9.name = "protein"] = instance9;
        var instance8 = new lib.virus_alive()
            .setTransform(385.7, 353.3, 0.547, 0.547);
        this[instance8.name = "virus_alive"] = instance8;
        var instance7 = new lib.virus_dead()
            .setTransform(373.4, 475.3, 0.55, 0.55);
        this[instance7.name = "virus_dead"] = instance7;
        var instance6 = new lib.virus_attenuated()
            .setTransform(488.4, 437.95, 0.547, 0.547);
        this[instance6.name = "virus_attenuated"] = instance6;
        var instance5 = new lib.antibiotic()
            .setTransform(542.65, 545.4, 0.873, 0.873);
        this[instance5.name = "antibiotic"] = instance5;
        var instance4 = new lib.syringe()
            .setTransform(611.25, 291.65, 0.771, 0.771)
            .setAlpha(0.5);
        this[instance4.name = "syringe"] = instance4;
        var instance3 = new lib.gray_kid2()
            .setTransform(767.75, 284.7, 0.771, 0.771)
            .setAlpha(0.5);
        this[instance3.name = "patient"] = instance3;
        var instance2 = new lib.expose_txt()
            .setTransform(786.9, 247.6, 0.771, 0.771)
            .setColorTransform(0, 0.82, 0, 0.57, 0, 0.08);
        var instance1 = new lib.inject_txt()
            .setTransform(614.9, 247.6, 0.771, 0.771)
            .setColorTransform(0, 0.82, 0, 0.57, 0, 0.08);
