(function (PIXI, lib) {
    ...
    lib.Game = MovieClip.extend(function () {
        ...
        var instance12 = new lib.syringe()
            .setTransform(964.15, 309.05)
            .setAlpha(0.5);
        this[instance12.name = "syringe"] = instance12;
        var instance11 = new lib.gray_kid2()
            .setTransform(1167.2, 300.05)
            .setAlpha(0.5);
        this[instance11.name = "patient"] = instance11;
        var instance10 = new lib.expose_txt()
            .setTransform(1192.05, 252)
            .setColorTransform(0, 0.82, 0, 0.57, 0, 0.08);
        var instance9 = new lib.inject_txt()
            .setTransform(968.9, 252)
            .setColorTransform(0, 0.82, 0, 0.57, 0, 0.08);
        var instance8 = new Text("Chose one of the types of microorganisms in the beaker and drag over to the right. You can inject your patient with a vaccine or expose them to a microbe, depending on what you have chosen.")
            .setStyle({
                fontFamily: "Tahoma",
                fontSize: 12,
                fontWeight: "bold",
