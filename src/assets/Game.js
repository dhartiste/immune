(function (PIXI, lib) {
    ...
    lib.pnlPopup2 = Container.extend(function () {
        Container.call(this);
        var instance4 = new lib.large_box()
            .setTransform(0, -3.9)
            .setAlpha(0.75);
        this[instance4.name = "box"] = instance4;
        var instance3 = new Text("attenuated virus detai\nmore\nmore")
            .setStyle({
                fontFamily: "Tahoma",
                fontSize: 12,
                fontWeight: "bold",
            ...
            .setTransform(11.55, 25.05);
        this[instance3.name = "popuptxt_det"] = instance3;
        var instance2 = new Text("attenuated virus2")
            .setStyle({
                fontFamily: "Tahoma",
                fontSize: 12,
                fontWeight: "bold",
    ...
    lib.panel = Container.extend(function () {
        Container.call(this);
        var instance2 = new lib.popupbox()
            .setTransform(0, 0, 1, 0.6)
            .setAlpha(0.75);
        var instance1 = new Text("attenuated virus")
            .setStyle({
                fontFamily: "Tahoma",
                fontSize: 12,
                fontWeight: "bold",
            ...
            .setTransform(8.5, 2, 1, 1.002);
        this[instance1.name = "popuptxt"] = instance1;
    ...
    lib.Game = MovieClip.extend(function () {
        ...
        var instance15 = new lib.expose_txt()
            .setTransform(1063.05, 234.7)
            .setColorTransform(0, 0.82, 0, 0.57, 0, 0.08);
        var instance14 = new lib.inject_txt()
        ...
        var instance11 = new lib.bacteria()
            .setTransform(561.55, 277.05, 0.621, 0.621);
        this[instance11.name = "bacteria"] = instance11;
        var instance10 = new lib.protein()
            .setTransform(675.1, 357.2);
        this[instance10.name = "protein"] = instance10;
        var instance9 = new lib.virus_alive()
            .setTransform(549.7, 389.35, 0.709, 0.709);
        this[instance9.name = "virus_alive"] = instance9;
        var instance8 = new lib.virus_dead()
            .setTransform(519.75, 547.65, 0.714, 0.714);
        this[instance8.name = "virus_dead"] = instance8;
        var instance7 = new lib.virus_attenuated()
        ...
        var instance5 = new lib.gray_kid2()
            ...
            .setAlpha(0.5);
        this[instance5.name = "patient"] = instance5;
        var instance4 = new lib.girl()
            .setTransform(1038.2, 282.75);
        this[instance4.name = "girl"] = instance4;
        var instance3 = new lib.syringe_1()
