(function (PIXI, lib) {
    ...
    lib.Game = MovieClip.extend(function () {
        ...
        var instance12 = new lib.bacteria()
            .setTransform(361.9, 301.5, 0.727, 0.73);
        this[instance12.name = "bacteria"] = instance12;
        var instance11 = new lib.protein()
            .setTransform(514.1, 393.6, 1.171, 1.177);
        this[instance11.name = "protein"] = instance11;
        var instance10 = new lib.virus_alive()
            .setTransform(374.2, 467.6, 0.831, 0.835);
        this[instance10.name = "virus_alive"] = instance10;
        var instance9 = new lib.virus_dead()
            .setTransform(339.15, 617.45, 0.836, 0.84);
        this[instance9.name = "virus_dead"] = instance9;
        var instance8 = new lib.virus_attenuated()
            .setTransform(513.9, 560.35, 0.831, 0.835);
        this[instance8.name = "virus_attenuated"] = instance8;
        var instance7 = new Text("Choose one of the types of microorganisms in the beaker and drag over to the right. You can inject your patient with a vaccine or expose them to a microbe, depending on what you have chosen.")
            .setStyle({
                fontFamily: "Tahoma",
                fontSize: 25,
                fontWeight: "bold",
            ...
            .setTransform(763.4, 105.95);
        this[instance7.name = "instructions"] = instance7;
        var instance6 = new lib.expose_txt()
            .setTransform(1194.95, 276.1)
            .setColorTransform(0, 0.82, 0, 0.57, 0, 0.08);
        var instance5 = new lib.inject_txt()
            .setTransform(823.8, 276.1)
            .setColorTransform(0, 0.82, 0, 0.57, 0, 0.08);
        var instance4 = new lib.syringe()
            .setTransform(823.8, 338.4, 1.641, 1.172)
            .setAlpha(0.5);
        this[instance4.name = "syringe"] = instance4;
        var instance3 = new lib.gray_kid2()
            .setTransform(1186.4, 340.7, 1.178, 1.129)
            .setAlpha(0.5);
        this[instance3.name = "patient"] = instance3;
        var instance2 = new lib.beaker_layered()
            .setTransform(245.95, 238.8, 1.171, 1.177);
        this[instance2.name = "beaker"] = instance2;
        var instance1 = new lib.bubbles_back()
            .setTransform(406.7, 99.95, 1.171, 1.177)
            .setAlpha(0.19549)
            .setColorTransform(-0.68, 1, 0.87, -0.6, -0.53, -0.75);
        this[instance1.name = "bubbles"] = instance1;
