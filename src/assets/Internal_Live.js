(function (PIXI, lib) {
    ...
    lib.virus_alive_sm = Container.extend(function () {
        ...
        var instance35 = new Graphics()
            .drawCommands(shapes.Internal[6])
            .setTransform(-19.9, -17.95, 1.037, 1.034);
        ...
        var instance29 = new Graphics()
            .drawCommands(shapes.Internal[13])
            .setTransform(-166.107, -114.533, 0.371, 0.371);
    ...
    lib.GameSafe = Container.extend(function () {
        Container.call(this);
        var instance1 = new Graphics()
            .drawCommands(shapes.Internal[212]);
        this.addChild(instance1);
    });
    ...
    lib.Internal = MovieClip.extend(function () {
        ...
        var instance9 = new lib.macro_virus_multiply()
            .setTransform(495.95, 600.25);
        this[instance9.name = "immune3"] = instance9;
        var instance8 = new lib.virus_alive_sm()
            .setTransform(1029.65, 236.9);
        this[instance8.name = "live_virus1"] = instance8;
        var instance7 = new lib.virus_alive_sm()
            .setTransform(1074.2, 383.35);
        this[instance7.name = "live_virus5"] = instance7;
        var instance6 = new lib.virus_alive_sm()
            .setTransform(968.35, 290.5);
        this[instance6.name = "live_virus2"] = instance6;
        var instance5 = new lib.virus_alive_sm()
            .setTransform(1079.65, 290.5);
        this[instance5.name = "live_virus3"] = instance5;
        var instance4 = new lib.virus_alive_sm()
            .setTransform(989.65, 360.5);
        this[instance4.name = "live_virus4"] = instance4;
        var instance3 = new lib.macro_virus_multiply()
            .setTransform(495.95, 400.65);
        this[instance3.name = "immune2"] = instance3;
        var instance2 = new lib.macro_virus_multiply()
            .setTransform(495.95, 197.35);
        this[instance2.name = "immune1"] = instance2;
